...
const VendorLogin = () => {
  ...
  const handleChange = (e) => {
    ...
    if (!formData.email || !formData.password) setIsAllFields(false);
    else setIsAllFields(true);
    setFormData((prev) => ({
      ...prev,
      [name]: value,
    }));
    ...
    <div className="max-w-md mx-auto p-6 bg-white shadow-md rounded-md mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className={`w-full ${
            isAllFields ? "bg-blue-600" : "bg-gray-600"
          } text-white py-2 rounded-md ${
            isAllFields ? "hover:bg-blue-700" : ""
      ...
      <div className="mt-5 text-center">
        <p>
          ...
          <Link className="text-blue-700 font-bold" to="/vendor/register">
            Register
          </Link>
        </p>
      </div>
